...
bulkImport: (data) => fetch(`${API_URL}/import`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) }).then(handleResponse),

    // Unified Bulk Move
    bulkMoveItems: (bookmarkIds, folderIds, targetFolderId) =>
        fetch(`${API_URL}/items/bulk-move`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ 
    ...
    // Unified Bulk Copy
    bulkCopyItems: (bookmarkIds, folderIds, targetFolderId, targetVault) =>
        fetch(`${API_URL}/items/bulk-copy`, {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ 
                bookmark_ids: bookmarkIds, 
